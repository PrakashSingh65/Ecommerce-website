...
const Hero = () => {
  return (
    <section>
        <div className='bg-green-300 min-h-screen max-w-\[1400px\] mx-auto px-10 flex md:flex-row flex-col item-center md:pt-25 pt-35'>
            <div className='flex-1'>
              ...
              <p className='text-zinc-500 md:text-lg text-md max-w-[530px] mt-5 mb-10'>
